...
public class WebSocketCreatorFactory {
    ...
    public static WebSocketCreator create(WebSocketHandlerWrapper handlerWrapper) {
        return new FlareWebSocketCreator(handlerWrapper.getHandler());
    }

    // Package protected to be visible to the unit tests
    static class FlareWebSocketCreator implements WebSocketCreator {
        private final Object handler;

        private FlareWebSocketCreator(Object handler) {
