 ...
 */
package flare.embeddedserver.jetty;
...
import flare.embeddedserver.jetty.websocket.WebSocketServletContextHandlerFactory;
import flare.ssl.SslStores;

/**
 * Flare server implementation
 *
 * @author Per Wendel
 */
public class EmbeddedJettyServer implements EmbeddedServer {
    ...
    private static final String NAME = "Flare";
