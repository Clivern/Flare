...
/**
 * The main building block of a Flare application is a set of routes. A route is
 ...
 * Ie. one should use:
 * 'post("/books")' without the prefix 'Flare.'
 *
 * @author Per Wendel
 */
public class Flare {
    ...
    /**
     * Statically import this for redirect utility functionality, see {@link flare.Redirect}
     */
    public static final Redirect redirect = getInstance().redirect;

    /**
     * Statically import this for static files utility functionality, see {@link flare.Service.StaticFiles}
     */
     ...
     * -
     * Note: contemplate changing tonew static files paradigm {@link flare.Service.StaticFiles}
     *
     ...
     * -
     * Note: contemplate use of new static files paradigm {@link flare.Service.StaticFiles}
     *
    ...
    /**
     * Waits for the Flare server to be stopped.
    ...
    /**
     * Sets Flare to trust Forwarded, X-Forwarded-Host, X-Forwarded-Server, X-Forwarded-For, X-Forwarded-Proto, X-Proxied-Https headers
    ...
    /**
     * Sets Flare to NOT trust Forwarded, X-Forwarded-Host, X-Forwarded-Server, X-Forwarded-For, X-Forwarded-Proto, X-Proxied-Https headers
     * as defined at https://www.eclipse.org/jetty/javadoc/current/org/eclipse/jetty/server/ForwardedRequestCustomizer.html
     */
    ...
    /**
     * Initializes the Flare server. SHOULD just be used when using the Websockets functionality.
     */
