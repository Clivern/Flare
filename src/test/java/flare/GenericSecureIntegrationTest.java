...
public class GenericSecureIntegrationTest {
    ...
    public static void setup() {
        ...
        // note that the keystore stuff is retrieved from FlareTestUtil which
        // respects JVM params for keystore, password
        // but offers a default included store if not.
        Flare.secure(FlareTestUtil.getKeyStoreLocation(),
                     FlareTestUtil.getKeystorePassword(), null, null);
    ...
    public void testGetHi() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethodSecure("GET", "/hi", null);
