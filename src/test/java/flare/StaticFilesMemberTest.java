...
public class StaticFilesMemberTest {
    ...
    public void testStaticFileCssStyleCss() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/css/style.css", null);
    ...
    public void testStaticFileMjs() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/js/module.mjs", null);
    ...
    public void testStaticFilePagesIndexHtml() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/pages/index.html", null);
        Assert.assertEquals(200, response.status);
    ...
    public void testStaticFilePageHtml() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/page.html", null);
        Assert.assertEquals(200, response.status);
    ...
    public void testExternalStaticFile() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/externalFile.html", null);
        Assert.assertEquals(200, response.status);
    ...
    public void testExceptionMapping404() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/filethatdoesntexist.html", null);
