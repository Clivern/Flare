...
public class ResponseBodyTest {
    ...
    public void testHELLO() {
        try {
            FlareTestUtil.UrlResponse response = http.get(HELLO);
    ...
    public void testSPECIAL() {
        try {
            FlareTestUtil.UrlResponse response = http.get(SPECIAL);
            assertEquals(200, response.status);
    ...
    public void testPORAKATIKAOKAO() {
        try {
            FlareTestUtil.UrlResponse response = http.get(PORAKATIKAOKAO);
            assertEquals(200, response.status);
    ...
    public void testMAXIME() {
        try {
            FlareTestUtil.UrlResponse response = http.get(MAXIME);
            assertEquals(200, response.status);
