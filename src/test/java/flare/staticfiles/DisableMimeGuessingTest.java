...
public class DisableMimeGuessingTest {
    ...
    public void testMimeTypes() throws Exception {
        ...
        Assert.assertNull(doGet("/img/flarelogo.png").headers.get("Content-Type"));
        Assert.assertNull(doGet("/img/flarelogo.svg").headers.get("Content-Type"));
        Assert.assertNull(doGet("/img/flarelogoPng").headers.get("Content-Type"));
        Assert.assertNull(doGet("/img/flarelogoSvg").headers.get("Content-Type"));
