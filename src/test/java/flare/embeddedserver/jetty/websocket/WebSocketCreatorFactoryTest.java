package flare.embeddedserver.jetty.websocket;
...
import flare.embeddedserver.jetty.websocket.WebSocketCreatorFactory.FlareWebSocketCreator;
...
public class WebSocketCreatorFactoryTest {
    ...
    public void testCreateWebSocketHandler() {
        ...
        assertTrue(annotated instanceof FlareWebSocketCreator);
        assertTrue(FlareWebSocketCreator.class.cast(annotated).getHandler() instanceof AnnotatedHandler);

        WebSocketCreator listener =
                WebSocketCreatorFactory.create(new WebSocketHandlerClassWrapper(ListenerHandler.class));
        assertTrue(listener instanceof FlareWebSocketCreator);
        assertTrue(FlareWebSocketCreator.class.cast(listener).getHandler() instanceof ListenerHandler);
    }
