 ...
 *         {@link flare.examples.simple.SimpleExample} by Per Wendel
 */
public class SimpleSecureExample {

    public static void main(String[] args) {

        // port(5678); <- Uncomment this if you want flare to listen on a
        // port different than 4567.

        secure(
                FlareTestUtil.getKeyStoreLocation(),
