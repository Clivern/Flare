 ...
 */
package flare.examples.multiple;

import flare.Service;

import static flare.Service.ignite;

/**
 * This example shows how to correctly use the Flare instance API which allows for multiple services.
 * The factory method 'service()' should be statically imported from the Flare class.
 */
