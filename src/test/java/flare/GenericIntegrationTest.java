...
import flare.embeddedserver.jetty.websocket.WebSocketTestClient;
import flare.embeddedserver.jetty.websocket.WebSocketTestHandler;
import flare.examples.exception.BaseException;
import flare.examples.exception.JWGmeligMeylingException;
import flare.examples.exception.NotFoundException;
import flare.examples.exception.SubclassOfBaseException;
import flare.util.FlareTestUtil;
import flare.util.FlareTestUtil.UrlResponse;

import static flare.Flare.after;
import static flare.Flare.afterAfter;
...
import static flare.Flare.patch;
import static flare.Flare.path;
import static flare.Flare.post;
import static flare.Flare.staticFileLocation;
import static flare.Flare.webSocket;
...
public class GenericIntegrationTest {
    ...
    public void testEchoParamWithUpperCaseInValue() throws Exception {
        final String camelCased = "ThisIsAValueAndFlareShouldRetainItsUpperCasedCharacters";
    ...
    public void testWebSocketConversation() throws Exception {
        ...
        Assert.assertEquals("onMessage: Hi Flare!", events.get(1));
