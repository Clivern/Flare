...
public class StaticFilesFromArchiveTest {
    ...
    public static void setup() throws Exception {
        ...
        Class<?> flareClass = classLoader.loadClass("flare.Flare");

        Method staticFileLocationMethod = flareClass.getMethod("staticFileLocation", String.class);
        staticFileLocationMethod.invoke(null, "/public-jar");

        Method initMethod = flareClass.getMethod("init");
        initMethod.invoke(null);

        Method awaitInitializationMethod = flareClass.getMethod("awaitInitialization");
    ...
    private static URLClassLoader createExtendedClassLoader() {
        ...
        // no parent classLoader because Flare and the static resources need to be loaded from the same classloader
