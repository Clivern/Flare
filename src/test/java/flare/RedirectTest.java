...
import static flare.Flare.redirect;

/**
 * Tests the redirect utility methods in {@link flare.Redirect}
 */
public class RedirectTest {
    ...
    public void testRedirectGet() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/hi", null);
    ...
    public void testRedirectPost() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("POST", "/hi", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectPut() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("PUT", "/hi", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectDelete() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("DELETE", "/hi", null);
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectAnyGet() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/any", null);
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectAnyPut() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("PUT", "/any", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectAnyPost() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("POST", "/any", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectAnyDelete() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("DELETE", "/any", "");
        Assert.assertEquals(200, response.status);
        Assert.assertEquals(REDIRECTED, response.body);
    }
    ...
    public void testRedirectGetWithSpecificCode() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/hiagain", null);
    ...
    public void testRedirectPostWithSpecificCode() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("POST", "/hiagain", "");
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectPutWithSpecificCode() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("PUT", "/hiagain", "");
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectDeleteWithSpecificCode() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("DELETE", "/hiagain", null);
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectAnyGetWithSpecificCode() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("GET", "/anyagain", null);
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectAnyPostWithSpecificCode() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("POST", "/anyagain", "");
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectAnyPutWithSpecificCode() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("PUT", "/anyagain", "");
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }

    @Test
    public void testRedirectAnyDeleteWithSpecificCode() throws Exception {
        FlareTestUtil.UrlResponse response = testUtil.doMethod("DELETE", "/anyagain", null);
        Assert.assertEquals(Redirect.Status.USE_PROXY.intValue(), response.status);
    }
